                ...
                <div style={styles.formCard}>
                    ...
                    {error && (
                        <div style={styles.errorAlert}>
                            <div>⚠️ {error}</div>
                            {emailTaken && (
                                <Link to="/login" style={styles.errorInlineLink}>Sign in to your account →</Link>
                            )}
                        </div>
                    )}
...
const styles = {
    ...
    errorInlineLink: { display: 'inline-block', marginTop: '8px', color: '#b91c1c', fontWeight: '700', fontSize: '13px', textDecoration: 'underline' },
